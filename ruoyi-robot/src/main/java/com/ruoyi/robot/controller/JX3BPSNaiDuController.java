...
public class JX3BPSNaiDuController {
    ...
    public void getNaiDuQiXue(MiraiGroupMessageEvent event){
        ...
        Image naiDuQiXue1 = event.getBot().uploadImageBlocking(Resource.of(new File("ruoyi-robot/src/main/resources/Image/NaiDu/奶毒奇穴1.png")));
        Image naiDuQiXue2 = event.getBot().uploadImageBlocking(Resource.of(new File("ruoyi-robot/src/main/resources/Image/NaiDu/奶毒奇穴2.png")));
        Image naiDuQiXue3 = event.getBot().uploadImageBlocking(Resource.of(new File("ruoyi-robot/src/main/resources/Image/NaiDu/奶毒奇穴3.png")));
        Image naiDuQiXue4 = event.getBot().uploadImageBlocking(Resource.of(new File("ruoyi-robot/src/main/resources/Image/NaiDu/奶毒奇穴4.png")));
        Image naiDuQiXue5 = event.getBot().uploadImageBlocking(Resource.of(new File("ruoyi-robot/src/main/resources/Image/NaiDu/奶毒奇穴5.png")));
    ...
    public void getNaiDuPeiZhuang(MiraiGroupMessageEvent event){
        ...
        Image naiDuPeiZhuang1 = event.getBot().uploadImageBlocking(Resource.of(new File("ruoyi-robot/src/main/resources/Image/NaiDu/奶毒配装1.png")));
        Image naiDuPeiZhuang2 = event.getBot().uploadImageBlocking(Resource.of(new File("ruoyi-robot/src/main/resources/Image/NaiDu/奶毒配装2.png")));
