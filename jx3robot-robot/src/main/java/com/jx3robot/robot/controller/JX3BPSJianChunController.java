...
public class JX3BPSJianChunController {
    ...
    public void getJianChunQiXue(MiraiGroupMessageEvent event){
        Text text1 = Text.of(
                "镜花影流派【单体推荐，较难】\n");
        Image image1 = event.getBot().uploadImageBlocking(Resource.of(FileUtil.getFileInputStream("/Image/JianChun/剑纯奇穴1.png")));
        Text text2 = Text.of(
                "云中剑流派：【群攻推荐】\n");
        Image image2 = event.getBot().uploadImageBlocking(Resource.of(FileUtil.getFileInputStream("/Image/JianChun/剑纯奇穴2.png")));
        Text text3 = Text.of(
                "无意流派：\n");
        Image image3 = event.getBot().uploadImageBlocking(Resource.of(FileUtil.getFileInputStream("/Image/JianChun/剑纯奇穴3.png")));
        Text text4 = Text.of(
                "分歧选择：\n" +
    ...
    public void getJianChunSimplePeiZhuang(MiraiGroupMessageEvent event){
        Image image1 = event.getBot().uploadImageBlocking(Resource.of(FileUtil.getFileInputStream("/Image/JianChun/剑纯配装1.png")));
        Image image2 = event.getBot().uploadImageBlocking(Resource.of(FileUtil.getFileInputStream("/Image/JianChun/剑纯配装2.png")));
    ...
    public void getJianChunJHYSimplePeiZhuang(MiraiGroupMessageEvent event){
        Image image1 = event.getBot().uploadImageBlocking(Resource.of(FileUtil.getFileInputStream("/Image/JianChun/剑纯配装3.png")));
