...
public class JX3BPSTieLaoController {
    ...
    public void getTieLaoPeiZhuang(MiraiGroupMessageEvent event){
        Image image1 = event.getBot().uploadImageBlocking(Resource.of(new File("jx3robot-robot/src/main/resources/Image/TieLao/铁牢配装1.png")));
        Image image2 = event.getBot().uploadImageBlocking(Resource.of(new File("jx3robot-robot/src/main/resources/Image/TieLao/铁牢配装2.png")));
        Image image3 = event.getBot().uploadImageBlocking(Resource.of(new File("jx3robot-robot/src/main/resources/Image/TieLao/铁牢配装3.png")));
    ...
    public void getTieLaoQiXue(MiraiGroupMessageEvent event){
        ...
        Image image1 = event.getBot().uploadImageBlocking(Resource.of(new File("jx3robot-robot/src/main/resources/Image/TieLao/奇穴1.png")));
        Text message2 = Text.of("\n2.常规输出奇穴\n" + "此为输出主T流派的通用奇穴，保留铁牢基本增益。力破万钧在通常情况下一般点不出来，所以不做考虑。\n");
        Image image2 = event.getBot().uploadImageBlocking(Resource.of(new File("jx3robot-robot/src/main/resources/Image/TieLao/奇穴2.png")));
        Text message3 = Text.of("\n3.群拉/群攻奇穴\n" + "此为铁牢群攻奇穴，使用战八方作为主要群体仇恨输出技能，烈雷作为群体强仇。目前适用于所有需要群拉的场合，包括河阳老三。\n");
        Image image3 = event.getBot().uploadImageBlocking(Resource.of(new File("jx3robot-robot/src/main/resources/Image/TieLao/奇穴3.png")));
